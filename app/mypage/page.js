      ...
      <div className="container px-4 py-6 mx-auto">
        <div className="max-w-3xl mx-auto">
          ...
          {error && (
            <Alert
              variant="destructive"
              className="mb-6 bg-red-50 border-red-200 rounded-xl"
            >
                        ...
                        >
                          ...
                          <div className="space-y-3">
                            <div className="grid grid-cols-2 gap-3">
                              ...
                              <div className="space-y-1">
                                <Label
                                  htmlFor={`contact-${contact.id}-relationship`}
                                  className="text-sm"
                                >
                                  관계
                                </Label>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="flex items-center justify-between space-x-2 p-3 border border-gray-100 rounded-lg">
                            ...
                            <Switch
                              ...
                              onCheckedChange={() =>
                                handleNotificationChange("medicationReminders")
                              }
                              className="data-[state=checked]:bg-purple-600 flex-shrink-0 h-6 w-11"
                            />
                          </div>
