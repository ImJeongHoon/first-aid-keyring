...
export default function PatientInfoPage() {
      ...
      try {
        ...
        if (data) {
          ...
          setMedicalInfo({
            ...
            recentSurgeries: data.surgeryHistory || "",
            organDonation: data.donorStatus || "",
  ...
  const validateFields = () => {
    ...
    if (!basicInfo.gender) newErrors.gender = "성별은 필수입니다.";
    if (!basicInfo.bloodType) newErrors.bloodType = "혈액형은 필수입니다.";
    setErrors(newErrors);
    return Object.keys(newErrors).length === 0;
  };

  const saveAllPatientInfo = async () => {
    if (!validateFields()) {
    ...
    const payload = {
      ...basicInfo,
      ...medicalInfo,
      notes: medicalInfo.specialNotes,
      ...
      <div className="container mx-auto px-4 py-6 flex-grow max-w-2xl">
        <div className="text-center mb-6">
          ...
          <p className="text-gray-600 mt-1">
            응급 상황에서 의료진이 확인할 수 있는 중요한 의료 정보를
            입력해주세요.
          </p>
        </div>
          ...
          {Object.values(tabConfig).map((tab) => {
            ...
            return (
              <button
                ...
                ${
                  activeTab === tab.value
                    ? "bg-white text-red-600 shadow border border-red-300"
        ...
        <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-200">
          <div
            className={`p-4 rounded-lg mb-6 ${tabConfig[activeTab].bgColor}`}
          >
          ...
          {activeTab === "basic" && (
            <div className="space-y-5">
              <div>
                ...
                >
                  <User className="w-4 h-4 mr-2 text-gray-500" /> 이름{" "}
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange(setBasicInfo, "name", e.target.value)
                  }
                  placeholder=""
                  className="mt-1"
                />
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange(setBasicInfo, "birthDate", e.target.value)
                  }
              ...
              <div>
                <Label
                  ...
                  className="font-medium text-gray-700 flex items-center"
                >
                  <User className="w-4 h-4 mr-2 text-gray-500" /> 성별{" "}
                  <span className="text-red-500 ml-1">*</span>
                </Label>
                <Select
                  value={basicInfo.gender}
                  onValueChange={(value) =>
                    handleInputChange(setBasicInfo, "gender", value)
                  }
                >
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    handleInputChange(setBasicInfo, "bloodType", value)
                  }
                >
                  <SelectTrigger className="mt-1">
              ...
              <div className="flex justify-between pt-4">
                ...
                <Button
                  ...
                  className="bg-red-500 hover:bg-red-600 text-white w-2/5"
                >
                  다음
                </Button>
              </div>
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    handleInputChange(setMedicalInfo, "organDonation", value)
                  }
                >
                  <SelectTrigger className="mt-1">
              ...
              <div className="flex justify-between pt-4">
                ...
                <Button
                  onClick={() => navigateTabs("next")}
                  className="bg-blue-500 hover:bg-blue-600 text-white w-2/5"
                >
                  다음
                </Button>
              </div>
            ...
            <div className="space-y-5">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange(setNewContact, "name", e.target.value)
                  }
                  placeholder=""
                  className="mt-1"
                />
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange(setNewContact, "phone", e.target.value)
                  }
                  placeholder=""
                  className="mt-1"
                />
              ...
              <div>
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    handleInputChange(setNewContact, "notes", e.target.value)
                  }
              ...
              {emergencyContacts.length > 0 && (
                <div className="pt-4">
                  <h3 className="text-lg font-semibold text-gray-700 mb-3 flex items-center">
                    <PhoneCallIcon className="w-5 h-5 mr-2 text-gray-500" />{" "}
                    등록된 비상 연락처
                  </h3>
